    ...
    return BlocProvider(
      ...
      child: BlocConsumer<AppCubit, AppStates>(
        ...
        builder: (BuildContext context, AppStates state){
          ...
          return Scaffold(
            key: _scaffoldKey,
            appBar: AppBar(title: Text(cubit.titles[cubit.currentIndex]), titleSpacing: 20.0,),
                            ...
                            defaultFormField(
                              ...
                              onTap: (){
                                showDatePicker(
                                  ...
                                  lastDate: DateTime.utc(2025), //parse("2021-12-00"),
                                ).then((value) {
                                  _dateController.text = DateFormat.yMMMd().format(value).toString();
                                });
                              },
                              validFun: (String value){
                                if(value.isEmpty)
